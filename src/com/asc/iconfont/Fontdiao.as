package com.asc.iconfont
{
	...
	public class Fontdiao extends BaseIconfont
	{
		[Embed(source="../../../../assets/fontdiao/fontdiao.ttf",fontName="fontdiao",mimeType="application/x-font-truetype",embedAsCFF="true",fontStyle="normal",fontWeight="normal")]
		private static var asset:Class;
		
		private static var fontName:String = "fontdiao";
		
		private static var intance:Fontdiao;
		
		public static function getIntance():Fontdiao
		{
			if (!intance)
			{
				intance = new Fontdiao();
			}
			return intance;
		}
		
		public function Fontdiao()
		{
		}
